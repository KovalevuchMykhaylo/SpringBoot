...
public class SizeTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        sw.append("<div class='dropdown lids-dropdown'><button class='btn btn-primary dropdown-toggle' type='button' data-toggle='dropdown'>");
        sw.append(title);
        sw.append("<span class='caret'></span></button>");
        sw.append("<ul class='dropdown-menu lids-dropdown-menu'>");
    ...
    public void setPosibleSizes(String posibleSizes) {
        ...
        while (tokenizer.hasMoreTokens()) {
            this.posibleSizes[i] = Integer.parseInt(tokenizer.nextToken());
            i++;
        }
    }
